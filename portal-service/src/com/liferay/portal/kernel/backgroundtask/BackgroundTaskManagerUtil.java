...
public class BackgroundTaskManagerUtil {
	...
	public static BackgroundTask<? extends BaseModel>
		addBackgroundTask(
	...
	public static BackgroundTask<? extends BaseModel> amendBackgroundTask(
	...
	public static void cleanUpBackgroundTask(
		BackgroundTask<? extends BaseModel> backgroundTask, int status) {
	...
	public static BackgroundTask<? extends BaseModel> deleteBackgroundTask(
	...
	public static BackgroundTask<? extends BaseModel> fetchBackgroundTask(
		long backgroundTaskId) {

		return _backgroundTaskManager.fetchBackgroundTask(backgroundTaskId);
	}

	public static BackgroundTask<? extends BaseModel> fetchFirstBackgroundTask(
	...
	public static BackgroundTask<? extends BaseModel> getBackgroundTask(
			long backgroundTaskId)
		throws PortalException {
