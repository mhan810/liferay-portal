 ...
 */
public interface BackgroundTaskManager<T extends BaseModel> {

	public BackgroundTask<T> addBackgroundTask(
	...
	public BackgroundTask<T> amendBackgroundTask(
	...
	public void cleanUpBackgroundTask(
		BackgroundTask<T> backgroundTask, int status);

	public void cleanUpBackgroundTasks();

	public BackgroundTask<T> deleteBackgroundTask(long backgroundTaskId)
		throws PortalException;
	...
	public BackgroundTask<T> fetchBackgroundTask(long backgroundTaskId);

	public BackgroundTask<T> fetchFirstBackgroundTask(
	...
	public BackgroundTask<T> getBackgroundTask(long backgroundTaskId)
		throws PortalException;

	public List<BackgroundTask<T>> getBackgroundTasks(long groupId, int status);

	public List<BackgroundTask<T>> getBackgroundTasks(
	...
	public BackgroundTask<T> updateBackgroundTask(
