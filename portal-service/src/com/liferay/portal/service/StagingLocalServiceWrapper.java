...
public class StagingLocalServiceWrapper implements StagingLocalService,
	...
	*/
	...
	public void cleanup(long stagingRequestId)
		...
		_stagingLocalService.cleanup(stagingRequestId);
	}

	@Override
	public long prepare(long userId, long groupId, java.lang.String checksum)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _stagingLocalService.prepare(userId, groupId, checksum);
	}

	@Override
	public void publish(long userId, long stagingRequestId,
		boolean privateLayout,
		java.util.Map<java.lang.String, java.lang.String[]> parameterMap)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		_stagingLocalService.publish(userId, stagingRequestId, privateLayout,
			parameterMap);
	}

	@Override
	public void stage(long userId, long stagingRequestId,
		java.lang.String fileName, byte[] byteBuffer)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		_stagingLocalService.stage(userId, stagingRequestId, fileName,
			byteBuffer);
	}
