...
public class StagingLocalServiceUtil {
	...
	*/
	...
	public static java.lang.String getLarChecksum(java.io.File file) {
		return getService().getLarChecksum(file);
	}

	public static void importTransferredLayouts(long userId, long groupId,
		...
		getService()
			.importTransferredLayouts(userId, groupId, privateLayout,
			parameterMap, fileName);
	}

	public static void receiveLayouts(java.lang.String fileName, byte[] bytes)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().receiveLayouts(fileName, bytes);
	}

	public static void transferLayouts(java.io.File file,
		com.liferay.portal.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().transferLayouts(file, serviceContext);
	}

	public static void validateTransferredLayouts(java.lang.String fileName,
		java.lang.String checksum)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().validateTransferredLayouts(fileName, checksum);
	}
