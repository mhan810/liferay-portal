...
public class BackgroundTaskLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.portal.model.BackgroundTask addBackgroundTask(
		...
		java.lang.Class backgroundTaskProcessorClass, java.lang.String name,
		...
		return getService()
			...
			backgroundTaskProcessorClass, name, data, serviceContext);
	}

	public static com.liferay.portal.model.BackgroundTask addBackgroundTask(
		long userId, long groupId,
		java.lang.Class backgroundTaskProcessorClass,
		...
		return getService()
				   .addBackgroundTask(userId, groupId,
			backgroundTaskProcessorClass, servletContextName, name, data,
			serviceContext);
	}
