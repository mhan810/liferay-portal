 ...
 * @generated
 */
public class RepositoryEntryExportActionableDynamicQuery
	extends RepositoryEntryActionableDynamicQuery {
	public RepositoryEntryExportActionableDynamicQuery(
	...
	protected String getManifestSummaryKey() {
		StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(RepositoryEntry.class.getName());
