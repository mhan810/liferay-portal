 ...
 * @generated
 */
public class LayoutExportActionableDynamicQuery
	extends LayoutActionableDynamicQuery {
	public LayoutExportActionableDynamicQuery(
	...
	protected String getManifestSummaryKey() {
		StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(Layout.class.getName());
