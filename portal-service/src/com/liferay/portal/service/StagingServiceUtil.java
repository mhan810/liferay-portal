...
public class StagingServiceUtil {
	...
	*/
	...
	public static void importTransferredLayouts(long groupId,
		...
		getService()
			.importTransferredLayouts(groupId, privateLayout, parameterMap,
			fileName);
	}

	public static void receiveLayouts(long groupId, java.lang.String fileName,
		byte[] bytes)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().receiveLayouts(groupId, fileName, bytes);
	}

	public static void validateTransferredLayouts(long groupId,
		java.lang.String fileName, java.lang.String checksum)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().validateTransferredLayouts(groupId, fileName, checksum);
	}
