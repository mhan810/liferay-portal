...
public class StagingServiceWrapper implements StagingService,
	...
	*/
	...
	public void cleanup(long stagingRequestId)
		...
		_stagingService.cleanup(stagingRequestId);
	}

	@Override
	public long prepare(long groupId, java.lang.String checksum)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _stagingService.prepare(groupId, checksum);
	}

	@Override
	public void publish(long stagingRequestId, boolean privateLayout,
		java.util.Map<java.lang.String, java.lang.String[]> parameterMap)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		_stagingService.publish(stagingRequestId, privateLayout, parameterMap);
	}

	@Override
	public void stage(long stagingRequestId, java.lang.String fileName,
		byte[] byteBuffer)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		_stagingService.stage(stagingRequestId, fileName, byteBuffer);
	}
