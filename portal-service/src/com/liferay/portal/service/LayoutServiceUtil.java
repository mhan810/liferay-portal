...
public class LayoutServiceUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void appendToImportLayoutsFile(java.lang.String fileId,
		byte[] bytes)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().appendToImportLayoutsFile(fileId, bytes);
	}
	...
	*/
	public static java.lang.String createImportLayoutsFileId()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().createImportLayoutsFileId();
	}
	...
	* @param fileId the file identifier what has been used to create the
	temporary file
	*/
	public static void deleteImportLayoutsFileForId(java.lang.String fileId) {
		getService().deleteImportLayoutsFileForId(fileId);
	}
	...
	*/
	public static void importLayouts(long groupId, boolean privateLayout,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().importLayouts(groupId, privateLayout, parameterMap, fileId);
	}
