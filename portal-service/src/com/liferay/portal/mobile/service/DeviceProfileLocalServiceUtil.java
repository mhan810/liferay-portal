...
/**
 * The utility for the device profile local service. This utility wraps {@link com.liferay.portal.mobile.service.impl.DeviceProfileLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class DeviceProfileLocalServiceUtil {
	...
	*/
	public static com.liferay.portal.mobile.model.DeviceProfile addDeviceProfile(
		...
		return getService().addDeviceProfile(deviceProfile);
	}
	...
	*/
	public static com.liferay.portal.mobile.model.DeviceProfile createDeviceProfile(
		long deviceProfileId) {
		return getService().createDeviceProfile(deviceProfileId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteDeviceProfile(long deviceProfileId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteDeviceProfile(deviceProfileId);
	}
	...
	*/
	public static void deleteDeviceProfile(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteDeviceProfile(deviceProfile);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portal.mobile.model.DeviceProfile getDeviceProfile(
		long deviceProfileId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDeviceProfile(deviceProfileId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.portal.mobile.model.DeviceProfile> getDeviceProfiles(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDeviceProfiles(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getDeviceProfilesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDeviceProfilesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portal.mobile.model.DeviceProfile updateDeviceProfile(
		com.liferay.portal.mobile.model.DeviceProfile deviceProfile)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateDeviceProfile(deviceProfile);
	}
	...
	*/
	public static com.liferay.portal.mobile.model.DeviceProfile updateDeviceProfile(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateDeviceProfile(deviceProfile, merge);
	}
	...
	*/
	...
	public static DeviceProfileLocalService getService() {
		if (_service == null) {
			_service = (DeviceProfileLocalService)PortalBeanLocatorUtil.locate(DeviceProfileLocalService.class.getName());

			ReferenceRegistry.registerReference(DeviceProfileLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DeviceProfileLocalService.class);
		}

		return _service;
	}

	public void setService(DeviceProfileLocalService service) {
		MethodCache.remove(DeviceProfileLocalService.class);
	...
	private static DeviceProfileLocalService _service;
}