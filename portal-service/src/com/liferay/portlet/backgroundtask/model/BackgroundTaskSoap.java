...
public class BackgroundTaskSoap implements Serializable {
	public static BackgroundTaskSoap toSoapModel(BackgroundTask model) {
		...
		soapModel.setBackgroundTaskContext(model.getBackgroundTaskContext());
	...
	public String getBackgroundTaskContext() {
		return _backgroundTaskContext;
	}

	public void setBackgroundTaskContext(String backgroundTaskContext) {
	...
	private String _backgroundTaskContext;
