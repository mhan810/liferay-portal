...
public class MDRActionServiceUtil {
	...
	public static com.liferay.portlet.mobiledevicerules.model.MDRAction addMDRAction(
		...
		return getService()
				   .addMDRAction(groupId, className, classPK, ruleGroupId,
	...
	public static void deleteActions(java.lang.String className, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteActions(className, classPK);
	}
	...
	public static com.liferay.portlet.mobiledevicerules.model.MDRAction updateMDRAction(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateMDRAction(actionId, nameMap, descriptionMap, type,
