 ...
 */
@Component(immediate = true, service = LayoutRevisionUADEntityTestHelper.class)
public class LayoutRevisionUADEntityTestHelper {
	/**
	 ...
	 *
	 */
	public LayoutRevision addLayoutRevisionWithStatusByUserId(long userId,
