...
@Component(immediate = true, property =  {
	"model.class.name=" + PortalUADConstants.CLASS_NAME_LAYOUT}, service = UADAnonymizer.class)
public class LayoutUADAnonymizer extends DynamicQueryUADAnonymizer<Layout> {
	@Override
	public void autoAnonymize(Layout layout, long userId)
