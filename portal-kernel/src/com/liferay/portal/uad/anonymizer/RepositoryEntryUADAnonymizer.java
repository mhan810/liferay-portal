...
@Component(immediate = true, property =  {
	"model.class.name=" + PortalUADConstants.CLASS_NAME_REPOSITORY_ENTRY}, service = UADAnonymizer.class)
public class RepositoryEntryUADAnonymizer extends DynamicQueryUADAnonymizer<RepositoryEntry> {
	@Override
	public void autoAnonymize(RepositoryEntry repositoryEntry, long userId)
		...
		_repositoryEntryLocalService.updateRepositoryEntry(repositoryEntry);
	}
