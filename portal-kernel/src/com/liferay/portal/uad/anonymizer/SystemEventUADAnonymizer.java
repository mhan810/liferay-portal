...
@Component(immediate = true, property =  {
	"model.class.name=" + PortalUADConstants.CLASS_NAME_SYSTEM_EVENT}, service = UADAnonymizer.class)
public class SystemEventUADAnonymizer extends DynamicQueryUADAnonymizer<SystemEvent> {
	@Override
	public void autoAnonymize(SystemEvent systemEvent, long userId)
		...
		_systemEventLocalService.updateSystemEvent(systemEvent);
	}
