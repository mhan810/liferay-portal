...
@Component(immediate = true, property =  {
	"model.class.name=" + PortalUADConstants.CLASS_NAME_PORTLET_ITEM}, service = UADAnonymizer.class)
public class PortletItemUADAnonymizer extends DynamicQueryUADAnonymizer<PortletItem> {
	@Override
	public void autoAnonymize(PortletItem portletItem, long userId)
		...
		_portletItemLocalService.updatePortletItem(portletItem);
	}
