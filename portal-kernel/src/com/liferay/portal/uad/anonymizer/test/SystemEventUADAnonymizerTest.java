...
import com.liferay.portal.uad.test.SystemEventUADEntityTestHelper;
...
public class SystemEventUADAnonymizerTest extends BaseUADAnonymizerTestCase {
	@ClassRule
	@Rule
	...
	protected BaseModel<?> addBaseModel(long userId, boolean deleteAfterTestRun)
		throws Exception {
		SystemEvent systemEvent = _systemEventUADEntityTestHelper.addSystemEvent(userId);
	...
	public void tearDown() throws Exception {
		_systemEventUADEntityTestHelper.cleanUpDependencies(_systemEvents);
	}
	...
	@Inject
	private SystemEventUADEntityTestHelper _systemEventUADEntityTestHelper;
	@Inject(filter = "model.class.name=" +
	PortalUADConstants.CLASS_NAME_SYSTEM_EVENT)
