...
/**
 * The base implementation of the device profile rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.mobile.service.impl.DeviceProfileRuleLocalServiceImpl}.
 * </p>
 *
 * @author Edward C. Han
...
public abstract class DeviceProfileRuleLocalServiceBaseImpl
	...
	public DeviceProfileRule addDeviceProfileRule(
		DeviceProfileRule deviceProfileRule) throws SystemException {
		deviceProfileRule.setNew(true);

		deviceProfileRule = deviceProfileRulePersistence.update(deviceProfileRule,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(deviceProfileRule);
			}
	 ...
	 */
	public DeviceProfileRule createDeviceProfileRule(long deviceProfileRuleId) {
		return deviceProfileRulePersistence.create(deviceProfileRuleId);
	}
	...
	public void deleteDeviceProfileRule(long deviceProfileRuleId)
		...
		DeviceProfileRule deviceProfileRule = deviceProfileRulePersistence.remove(deviceProfileRuleId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(deviceProfileRule);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return deviceProfileRulePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return deviceProfileRulePersistence.countWithDynamicQuery(dynamicQuery);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DeviceProfileRule> getDeviceProfileRules(int start, int end)
		throws SystemException {
		return deviceProfileRulePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDeviceProfileRulesCount() throws SystemException {
		return deviceProfileRulePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DeviceProfileRule updateDeviceProfileRule(
		DeviceProfileRule deviceProfileRule) throws SystemException {
		return updateDeviceProfileRule(deviceProfileRule, true);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = deviceProfileRulePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DeviceProfileRuleLocalServiceBaseImpl.class);
