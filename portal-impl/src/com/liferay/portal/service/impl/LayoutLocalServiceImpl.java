...
public class LayoutLocalServiceImpl extends LayoutLocalServiceBaseImpl {
	...
	public BTEntry exportLayoutsInBackground(
		...
		return btEntryLocalService.addEntry(
	...
	public BTEntry exportPortletInfoInBackground(
	...
	public BTEntry importLayoutsInBackground(
			long userId, String taskName, long groupId, boolean privateLayout,
			Map<String, String[]> parameterMap, File file)
		throws PortalException, SystemException {
	...
	public BTEntry importPortletInfoInBackground(
			long userId, String taskName, long plid, long groupId,
