...
public class ${entity.name}ExportActionableDynamicQuery extends ${entity.name}ActionableDynamicQuery {
	...
	protected void addCriteria(DynamicQuery dynamicQuery) {
		_portletDataContext.addDateRangeCriteria(PortletDataContext.DATE_RANGE_CONTENT, dynamicQuery, "modifiedDate");
	}
		...
		ActionableDynamicQuery actionableDynamicQuery =
			new SocialActivityActionableDynamicQuery() {
				...
				protected void addCriteria(DynamicQuery dynamicQuery) {
					...
					DateRange dateRange = _portletDataContext.getDateRange(
