...
import com.liferay.portlet.backgroundtask.model.BackgroundTaskModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portlet.backgroundtask.model.BackgroundTaskModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link BackgroundTaskImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see BackgroundTaskImpl
 * @see com.liferay.portlet.backgroundtask.model.BackgroundTask
 * @see com.liferay.portlet.backgroundtask.model.BackgroundTaskModel
 * @generated
 */
public class BackgroundTaskModelImpl extends BaseModelImpl<BackgroundTask>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a background task model instance should use the {@link com.liferay.portlet.backgroundtask.model.BackgroundTask} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.liferay.portlet.backgroundtask.model.BackgroundTask"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.liferay.portlet.backgroundtask.model.BackgroundTask"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.com.liferay.portlet.backgroundtask.model.BackgroundTask"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.portal.util.PropsUtil.get(
				"lock.expiration.time.com.liferay.portlet.backgroundtask.model.BackgroundTask"));
	...
	public String getBackgroundTaskContext() {
		if (_backgroundTaskContext == null) {
			return StringPool.BLANK;
		}
		else {
	...
	public Object clone() {
		...
		backgroundTaskImpl.setBackgroundTaskContext(getBackgroundTaskContext());
	...
	public CacheModel<BackgroundTask> toCacheModel() {
		...
		backgroundTaskCacheModel.backgroundTaskContext = getBackgroundTaskContext();

		String backgroundTaskContext = backgroundTaskCacheModel.backgroundTaskContext;

		if ((backgroundTaskContext != null) &&
				(backgroundTaskContext.length() == 0)) {
			backgroundTaskCacheModel.backgroundTaskContext = null;
		}
	...
	public String toString() {
		...
		sb.append(getBackgroundTaskContext());
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.portlet.backgroundtask.model.BackgroundTask");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>backgroundTaskContext</column-name><column-value><![CDATA[");
		sb.append(getBackgroundTaskContext());
		sb.append("]]></column-value></column>");
		sb.append(
