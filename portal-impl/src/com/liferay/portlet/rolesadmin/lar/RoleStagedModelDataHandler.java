...
public class RoleStagedModelDataHandler
	...
	protected void doExportStagedModel(
		...
		portletDataContext.addClassedModel(
			roleElement, StagedModelPathUtil.getPath(role), role,
			RoleAdminPortletDataHandler.NAMESPACE);
	}
	...
	protected void doImportStagedModel(
		...
		ServiceContext serviceContext = portletDataContext.createServiceContext(
			role, RoleAdminPortletDataHandler.NAMESPACE);
		...
		if (existingRole == null) {
			existingRole =
				RoleLocalServiceUtil.fetchRole(companyId, role.getName());
		}
		...
		portletDataContext.importClassedModel(
			role, importedRole, RoleAdminPortletDataHandler.NAMESPACE);
