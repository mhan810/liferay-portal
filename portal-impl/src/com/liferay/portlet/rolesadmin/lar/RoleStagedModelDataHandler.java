...
import com.liferay.portal.security.permission.PermissionConverter;
...
public class RoleStagedModelDataHandler
	...
	protected void clearPermissions(
		...
		List<ResourceTypePermission> resourceTypePermissions =
			ResourceTypePermissionLocalServiceUtil.
				getRoleResourceTypePermissions(importedRole.getRoleId());
	...
	protected void doExportStagedModel(
		...
		PermissionConverter permissionConverter =
			PermissionConverterUtil.getPermissionConverter();
	...
	protected void doImportStagedModel(
		...
		if (existingRole == null) {
			...
			clearPermissions(portletDataContext, importedRole);
		}
