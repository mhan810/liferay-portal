...
public class MDRActionServiceHttp {
	public static com.liferay.portlet.mobiledevicerules.model.MDRAction addMDRAction(
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(methodKey, groupId,
					className, classPK, ruleGroupId, nameMap, descriptionMap,
	...
	public static void deleteActions(HttpPrincipal httpPrincipal,
		java.lang.String className, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		try {
			MethodKey methodKey = new MethodKey(MDRActionServiceUtil.class.getName(),
					"deleteActions", _deleteActionsParameterTypes3);
	...
	public static com.liferay.portlet.mobiledevicerules.model.MDRAction updateMDRAction(
		...
		try {
			MethodKey methodKey = new MethodKey(MDRActionServiceUtil.class.getName(),
					"updateMDRAction", _updateMDRActionParameterTypes7);
	...
	private static final Class<?>[] _deleteActionsParameterTypes3 = new Class[] {
	...
	private static final Class<?>[] _updateMDRActionParameterTypes7 = new Class[] {
			long.class, java.util.Map.class, java.util.Map.class,
