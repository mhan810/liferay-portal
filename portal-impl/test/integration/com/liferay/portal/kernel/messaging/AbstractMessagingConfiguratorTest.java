...
public class AbstractMessagingConfiguratorTest {
	...
	public void testCustomClassLoaderDestinationConfig() {
		...
		destinationConfigs.add(
			DestinationConfig.createSynchronousDestinationConfig(
				"liferay/plugintest"));
		destinationConfigs.add(
			DestinationConfig.createParallelDestinationConfig(
				"liferay/plugintest2"));

		pluginMessagingConfigurator.setDestinationConfigs(destinationConfigs);
	...
	public void testPortalClassLoaderDestinationConfig() {
		...
		defaultMessagingConfigurator.setDestinationConfigs(destinationConfigs);
