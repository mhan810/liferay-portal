...
public class BackgroundTaskPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newBackgroundTask.setClassName(ServiceTestUtil.randomString());

		newBackgroundTask.setCompletedDate(ServiceTestUtil.nextDate());

		newBackgroundTask.setData(ServiceTestUtil.randomString());

		newBackgroundTask.setName(ServiceTestUtil.randomString());

		newBackgroundTask.setServletContextName(ServiceTestUtil.randomString());
		...
		Assert.assertEquals(existingBackgroundTask.getClassName(),
			newBackgroundTask.getClassName());
		Assert.assertEquals(Time.getShortTimestamp(
				existingBackgroundTask.getCompletedDate()),
			Time.getShortTimestamp(newBackgroundTask.getCompletedDate()));
		Assert.assertEquals(existingBackgroundTask.getData(),
			newBackgroundTask.getData());
		Assert.assertEquals(existingBackgroundTask.getName(),
			newBackgroundTask.getName());
		Assert.assertEquals(existingBackgroundTask.getServletContextName(),
			newBackgroundTask.getServletContextName());
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("BackgroundTask",
			...
			"modifiedDate", true, "className", true, "completedDate", true,
			"data", true, "name", true, "servletContextName", true, "status",
			true);
	}
	...
	protected BackgroundTask addBackgroundTask() throws Exception {
		...
		backgroundTask.setClassName(ServiceTestUtil.randomString());

		backgroundTask.setCompletedDate(ServiceTestUtil.nextDate());

		backgroundTask.setData(ServiceTestUtil.randomString());

		backgroundTask.setName(ServiceTestUtil.randomString());

		backgroundTask.setServletContextName(ServiceTestUtil.randomString());
