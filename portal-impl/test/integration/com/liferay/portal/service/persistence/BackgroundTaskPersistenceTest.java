...
public class BackgroundTaskPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newBackgroundTask.setType(ServiceTestUtil.randomString());
		...
		Assert.assertEquals(existingBackgroundTask.getType(),
			newBackgroundTask.getType());
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("BackgroundTask",
			...
			"modifiedDate", true, "type", true, "status", true, "name", true,
			"completedDate", true, "data", true);
	}
	...
	protected BackgroundTask addBackgroundTask() throws Exception {
		...
		backgroundTask.setType(ServiceTestUtil.randomString());
