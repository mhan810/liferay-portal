...
public class BackgroundTaskPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newBackgroundTask.setBackgroundTaskContext(ServiceTestUtil.randomString());
		...
		Assert.assertEquals(existingBackgroundTask.getBackgroundTaskContext(),
			newBackgroundTask.getBackgroundTaskContext());
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("BackgroundTask",
			...
			"modifiedDate", true, "backgroundTaskContext", true,
			"taskExecutorClassName", true, "completionDate", true, "name",
			true, "servletContextName", true, "status", true);
	}
	...
	protected BackgroundTask addBackgroundTask() throws Exception {
		...
		backgroundTask.setBackgroundTaskContext(ServiceTestUtil.randomString());
