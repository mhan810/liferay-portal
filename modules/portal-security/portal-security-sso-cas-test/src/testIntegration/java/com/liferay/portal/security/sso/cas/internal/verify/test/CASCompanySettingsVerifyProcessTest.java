...
public class CASCompanySettingsVerifyProcessTest
	...
	public static void setUpClass() throws PortalException {
		...
		properties.put(LegacyCASPropsKeys.CAS_LOGIN_URL, "test/cas/login/url");
		...
		properties.put(
			LegacyCASPropsKeys.CAS_LOGOUT_URL, "test/cas/logout/url");

		properties.put(
			LegacyCASPropsKeys.CAS_NO_SUCH_USER_REDIRECT_URL,
			"test/cas/no/such/user/redirect/url");

		properties.put(LegacyCASPropsKeys.CAS_SERVER_NAME, "testCasServerName");

		properties.put(
			LegacyCASPropsKeys.CAS_SERVER_URL, "test/cas/server/url");

		properties.put(
			LegacyCASPropsKeys.CAS_SERVICE_URL, "test/cas/service/url");
