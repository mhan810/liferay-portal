...
public class OpenSSOCompanySettingsVerifyProcessTest
	...
	public static void setUpClass() throws PortalException {
		...
		properties.put(
			LegacyOpenSSOPropsKeys.OPENSSO_LOGIN_URL, "test/login/url");
		...
		properties.put(
			LegacyOpenSSOPropsKeys.OPENSSO_LOGOUT_URL, "test/logout/url");
		...
		properties.put(
			LegacyOpenSSOPropsKeys.OPENSSO_SERVICE_URL, "test/service/url");
