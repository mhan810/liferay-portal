...
import com.liferay.portal.workflow.kaleo.internal.runtime.util.comparators.KaleoLogOrderByComparator;
 ...
 */
@Component(immediate = true, service = WorkflowLogManagerImpl.class)
