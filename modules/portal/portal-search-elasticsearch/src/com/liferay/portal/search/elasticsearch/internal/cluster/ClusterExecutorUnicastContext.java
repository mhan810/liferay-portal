 ...
 */
@Component(immediate = true, service = UnicastContext.class)
public class ClusterExecutorUnicastContext implements UnicastContext {
	...
	public String[] getHosts() {
		...
		for (int i = 0; i < addresses.length; i++) {
			...
			addresses[i] = bindInetAddress.getHostAddress() + "[9300-9350]";
		}
