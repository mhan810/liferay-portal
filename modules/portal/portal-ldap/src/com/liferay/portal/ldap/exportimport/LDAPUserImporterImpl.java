...
public class LDAPUserImporterImpl implements LDAPUserImporter, UserImporter {
	...
	public void importUsers(long companyId) throws Exception {
		...
		try {
			...
			_lockManager.lock(
				...
				ldapCompanyServiceSettings.importLockExpirationTime());
	...
	protected User updateUser(
		...
		if (!ldapCompanyServiceSettings.importUserPasswordEnabled()) {
			password = ldapCompanyServiceSettings.importUserPasswordDefault();
