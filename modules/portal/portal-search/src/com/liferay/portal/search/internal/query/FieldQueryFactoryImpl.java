...
public class FieldQueryFactoryImpl implements FieldQueryFactory {
	...
	public Query createQuery(
		...
		boolean hasPhraseValue = false;

		int pos1 = value.indexOf(StringPool.QUOTE);
		int pos2 = value.lastIndexOf(StringPool.QUOTE);
		...
		if (like || (isSubstringSearchAlways && !hasPhraseValue)) {
