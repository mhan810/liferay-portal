...
public class DDMTemplatePersistenceImpl extends BasePersistenceImpl<DDMTemplate>
	...
	public List<DDMTemplate> findByUuid(String uuid, int start, int end,
		...
		List<DDMTemplate> list = (List<DDMTemplate>)finderCache.getResult(finderPath,
				finderArgs, this);
	...
	public List<DDMTemplate> findByG_CPK(long[] groupIds, long classPK,
		...
		List<DDMTemplate> list = (List<DDMTemplate>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_CPK,
				finderArgs, this);
	...
	public List<DDMTemplate> findByG_C_C(long[] groupIds, long classNameId,
		...
		List<DDMTemplate> list = (List<DDMTemplate>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_C,
				finderArgs, this);
