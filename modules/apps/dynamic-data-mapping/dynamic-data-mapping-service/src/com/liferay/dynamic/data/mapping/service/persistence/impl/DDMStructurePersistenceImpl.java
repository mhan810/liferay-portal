...
public class DDMStructurePersistenceImpl extends BasePersistenceImpl<DDMStructure>
	...
	public List<DDMStructure> findByUuid(String uuid, int start, int end,
		...
		List<DDMStructure> list = (List<DDMStructure>)finderCache.getResult(finderPath,
				finderArgs, this);
	...
	public List<DDMStructure> findByGroupId(long[] groupIds, int start,
		...
		List<DDMStructure> list = (List<DDMStructure>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID,
				finderArgs, this);
	...
	public List<DDMStructure> findByG_C(long[] groupIds, long classNameId,
		...
		List<DDMStructure> list = (List<DDMStructure>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C,
				finderArgs, this);
