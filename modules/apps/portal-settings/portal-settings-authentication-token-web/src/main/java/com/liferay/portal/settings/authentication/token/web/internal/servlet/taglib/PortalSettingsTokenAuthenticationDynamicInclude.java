...
/**
 * Adds a Token tab to the Authentication section of the Portal Settings user
...
public class PortalSettingsTokenAuthenticationDynamicInclude
	extends BaseJSPDynamicInclude {

	@Override
	protected String getJspPath() {
		return "/com.liferay.portal.settings.web/token.jsp";
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PortalSettingsTokenAuthenticationDynamicInclude.class);
