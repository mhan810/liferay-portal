...
public class BookmarksEntryPersistenceImpl extends BasePersistenceImpl<BookmarksEntry>
	...
	public List<BookmarksEntry> findByResourceBlockId(long resourceBlockId,
		...
		List<BookmarksEntry> list = (List<BookmarksEntry>)finderCache.getResult(finderPath,
				finderArgs, this);
	...
	public List<BookmarksEntry> findByG_F(long groupId, long[] folderIds,
		...
		List<BookmarksEntry> list = (List<BookmarksEntry>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_F,
				finderArgs, this);
	...
	public List<BookmarksEntry> findByG_F_S(long groupId, long[] folderIds,
		...
		List<BookmarksEntry> list = (List<BookmarksEntry>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_F_S,
				finderArgs, this);
	...
	public List<BookmarksEntry> findByG_F_NotS(long groupId, long[] folderIds,
		...
		List<BookmarksEntry> list = (List<BookmarksEntry>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_F_NOTS,
				finderArgs, this);
	...
	public List<BookmarksEntry> findByG_U_F_S(long groupId, long userId,
		...
		List<BookmarksEntry> list = (List<BookmarksEntry>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U_F_S,
				finderArgs, this);
