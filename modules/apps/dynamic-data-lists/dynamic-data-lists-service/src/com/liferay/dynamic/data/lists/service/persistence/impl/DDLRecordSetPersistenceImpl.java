...
public class DDLRecordSetPersistenceImpl extends BasePersistenceImpl<DDLRecordSet>
	...
	public List<DDLRecordSet> findByUuid(String uuid, int start, int end,
		...
		List<DDLRecordSet> list = (List<DDLRecordSet>)finderCache.getResult(finderPath,
				finderArgs, this);
	...
	public List<DDLRecordSet> findByGroupId(long[] groupIds, int start,
		...
		List<DDLRecordSet> list = (List<DDLRecordSet>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID,
				finderArgs, this);
