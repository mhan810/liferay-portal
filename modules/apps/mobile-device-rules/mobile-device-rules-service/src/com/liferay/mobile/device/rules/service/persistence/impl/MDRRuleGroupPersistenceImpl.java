...
public class MDRRuleGroupPersistenceImpl extends BasePersistenceImpl<MDRRuleGroup>
	...
	public List<MDRRuleGroup> findByUuid(String uuid, int start, int end,
		...
		List<MDRRuleGroup> list = (List<MDRRuleGroup>)finderCache.getResult(finderPath,
				finderArgs, this);
	...
	public List<MDRRuleGroup> findByGroupId(long[] groupIds, int start,
		...
		List<MDRRuleGroup> list = (List<MDRRuleGroup>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID,
				finderArgs, this);
