...
public class ElasticsearchClusterRequestExecutorTest {
	...
	public void setUp() throws Exception {
		...
		_elasticsearchClusterRequestExecutor.healthClusterRequestExecutor =
			_healthClusterRequestExecutor;
		_elasticsearchClusterRequestExecutor.stateClusterRequestExecutor =
			_stateClusterRequestExecutor;
		_elasticsearchClusterRequestExecutor.statsClusterRequestExecutor =
	...
	public void testExecuteStateClusterRequest() {
		StateClusterRequest stateClusterRequest = new StateClusterRequest(null);
