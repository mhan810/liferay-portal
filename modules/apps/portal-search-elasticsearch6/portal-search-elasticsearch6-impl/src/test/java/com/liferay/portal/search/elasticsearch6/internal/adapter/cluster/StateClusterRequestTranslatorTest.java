 ...
 */
public class StateClusterRequestTranslatorTest {
	...
	public void testClusterRequestTranslation() {
		...
		StateClusterRequestTranslatorImpl stateClusterRequestTranslator =
			new StateClusterRequestTranslatorImpl();

		ClusterStateRequestBuilder clusterStateRequestBuilder =
			stateClusterRequestTranslator.createBuilder(
