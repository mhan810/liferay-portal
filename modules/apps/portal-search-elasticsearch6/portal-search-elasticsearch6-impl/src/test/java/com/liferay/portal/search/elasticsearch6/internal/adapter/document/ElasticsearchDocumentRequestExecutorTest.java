...
public class ElasticsearchDocumentRequestExecutorTest {
	...
	public void setUp() throws Exception {
		...
		_elasticsearchDocumentRequestExecutor.deleteDocumentRequestExecutor =
			_deleteDocumentRequestExecutor;
		_elasticsearchDocumentRequestExecutor.indexDocumentRequestExecutor =
			_indexDocumentRequestExecutor;
		_elasticsearchDocumentRequestExecutor.
			updateByQueryDocumentRequestExecutor =
				_updateByQueryDocumentRequestExecutor;
		_elasticsearchDocumentRequestExecutor.updateDocumentRequestExecutor =
