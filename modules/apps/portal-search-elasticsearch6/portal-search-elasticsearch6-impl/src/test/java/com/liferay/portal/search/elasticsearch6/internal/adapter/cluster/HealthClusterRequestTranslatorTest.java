 ...
 */
public class HealthClusterRequestTranslatorTest {
	...
	public void testClusterRequestTranslation() {
		...
		HealthClusterRequestTranslatorImpl healthClusterRequestTranslator =
			new HealthClusterRequestTranslatorImpl();

		ClusterHealthRequestBuilder clusterHealthRequestBuilder =
			healthClusterRequestTranslator.createBuilder(
