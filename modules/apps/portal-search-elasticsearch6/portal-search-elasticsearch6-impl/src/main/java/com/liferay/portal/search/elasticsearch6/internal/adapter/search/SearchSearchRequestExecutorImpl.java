...
public class SearchSearchRequestExecutorImpl
	...
	public SearchSearchResponse execute(
		...
		searchRequestBuilderConfigurator.configure(
		...
		baseSearchResponsePopulator.populate(
		...
		if (searchSearchRequest.getGroupBy() != null) {
			updateGroupedHits(
				...
				searchResponse.getAggregations(), query, hits);
		}
		...
		processSearchHits(searchHits, query, hits);
	...
	@Reference
	protected BaseSearchResponsePopulator baseSearchResponsePopulator;
	...
	@Reference
	protected SearchRequestBuilderConfigurator searchRequestBuilderConfigurator;
