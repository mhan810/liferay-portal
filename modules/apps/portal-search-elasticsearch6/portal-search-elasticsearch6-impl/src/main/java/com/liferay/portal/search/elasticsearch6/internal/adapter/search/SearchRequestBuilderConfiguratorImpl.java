 ...
 */
@Component(immediate = true, service = SearchRequestBuilderConfigurator.class)
public class SearchRequestBuilderConfiguratorImpl
	implements SearchRequestBuilderConfigurator {
