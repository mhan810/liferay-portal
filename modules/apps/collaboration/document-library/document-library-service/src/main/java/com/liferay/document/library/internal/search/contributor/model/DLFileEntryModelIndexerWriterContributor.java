...
public class DLFileEntryModelIndexerWriterContributor
	...
	public void customize(
		...
		final IndexerDocumentBuilder<DLFileEntry> indexerDocumentBuilder,
		long companyId) {

		indexableActionableDynamicQuery.setCompanyId(companyId);
		indexableActionableDynamicQuery.setInterval(_dlFileIndexingInterval);
		...
		try {
			...
			if (_log.isWarnEnabled()) {
				_log.warn("Error reindexing documents", pe);
			}
		}
	}

	@Override
	public Optional<DLFileEntry> getBaseModel(long classPK) {
		DLFileEntry dlFileEntry = dlFileEntryLocalService.fetchDLFileEntry(
			classPK);

		return Optional.ofNullable(dlFileEntry);
	}
	...
	public IndexableActionableDynamicQuery
		...
		return dlFileEntryLocalService.getIndexableActionableDynamicQuery();
	}
	...
	protected IndexerDocumentBuilder<DLFileEntry> indexerDocumentBuilder;
