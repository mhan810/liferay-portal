...
public class NoAutoCommitIndexer<T> implements Indexer<T> {
	...
	/**
	 * @deprecated As of 1.0.0, replaced by {@link #getSearchClassNames}
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of 1.0.0, replaced by {@link #getClassName}
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of 1.0.0, replaced by {@link #getSummary(Document, String,
