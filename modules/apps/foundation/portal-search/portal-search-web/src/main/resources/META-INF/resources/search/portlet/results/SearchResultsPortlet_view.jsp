...
<%
com.liferay.portal.search.web.internal.portlet.results.SearchResultsDisplayContext searchResultsDisplayContext = (com.liferay.portal.search.web.internal.portlet.results.SearchResultsDisplayContext)java.util.Objects.requireNonNull(request.getAttribute(com.liferay.portal.search.web.internal.portlet.results.SearchResultsWebKeys.DISPLAY_CONTEXT));

if (searchResultsDisplayContext.isRenderNothing()) {
	return;
}

com.liferay.portal.kernel.dao.search.SearchContainer<com.liferay.portal.kernel.search.Document> searchContainer1 = searchResultsDisplayContext.getSearchContainer();
%>
...
<p class="search-total-label text-default">
	<%= searchContainer1.getTotal() %> results for <strong><%= searchResultsDisplayContext.getKeywords() %></strong>
</p>
