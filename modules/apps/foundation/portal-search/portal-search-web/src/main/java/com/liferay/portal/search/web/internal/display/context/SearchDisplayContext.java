...
import com.liferay.portal.search.web.internal.search.SearchResponseImpl;
...
public class SearchDisplayContext {
	...
	public SearchDisplayContext(
		...
		searchImpl.addSearchSettingsContributor(this::contributeSearchSettings);

		SearchResponseImpl searchResponseImpl = searchImpl.search();
