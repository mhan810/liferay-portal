 ...
 */
public class HealthClusterRequest implements ClusterRequest {

	public HealthClusterRequest(String indexName) {
		_indexName = indexName;
	}

	@Override
	public <T> T accept(
		ClusterRequestExecutor<T> clusterRequestExecutor) {
