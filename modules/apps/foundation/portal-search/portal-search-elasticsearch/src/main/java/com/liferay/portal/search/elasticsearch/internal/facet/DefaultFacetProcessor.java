...
public class DefaultFacetProcessor
	...
	protected void activate(Map<String, Object> properties) {
		...
		com.liferay.portal.search.elasticsearch.internal.configuration.FacetConfiguration facetConfiguration =
			ConfigurableUtil.createConfigurable(
				com.liferay.portal.search.elasticsearch.internal.configuration.FacetConfiguration.class, properties);
	...
	private Set<String> _textKeywordFacets = new HashSet<>();
}