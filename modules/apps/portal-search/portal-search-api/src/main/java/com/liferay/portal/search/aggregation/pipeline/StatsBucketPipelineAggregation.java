 ...
 */
@ProviderType
public class StatsBucketPipelineAggregation
	extends BucketMetricsPipelineAggregation implements PipelineAggregation {

	public StatsBucketPipelineAggregation(String name, String bucketsPath) {
