...
package com.liferay.portal.search.test.util.aggregation.metrics.geocentroid;
...
public abstract class BaseGeoCentroidAggregationTestCase
	...
	public void testGeoCentroidAggregation() throws Exception {
		...
		GeoCentroidAggregation geoBoundsAggregation =
			new GeoCentroidAggregation("geoCentroid", Field.GEO_LOCATION);

		GeoCentroidAggregationResult geoCentroidAggregationResult = search(
