...
package com.liferay.portal.search.test.util.aggregation.bucket.geohashgrid;
...
public abstract class BaseGeoHashGridAggregationTestCase
	...
	public void testGeoHashGrid() throws Exception {
		...
		GeoHashGridAggregation geoHashGridAggregation =
			new GeoHashGridAggregation("geoHash", Field.GEO_LOCATION);

		geoHashGridAggregation.setPrecision(3);

		GeoHashGridAggregationResult geoBoundsAggregationResult = search(
