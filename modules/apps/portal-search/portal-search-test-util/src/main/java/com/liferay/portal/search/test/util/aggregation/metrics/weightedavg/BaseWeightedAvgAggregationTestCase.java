...
package com.liferay.portal.search.test.util.aggregation.metrics.weightedavg;
...
public abstract class BaseWeightedAvgAggregationTestCase
	...
	public void testWeightedAverage() {
		...
		WeightedAvgAggregationResult weightedAvgAggregationResult = search(
			weightedAvgAggregation);

		Assert.assertEquals(
			3.66666666666666666666665, weightedAvgAggregationResult.getValue(),
			0);
	}
