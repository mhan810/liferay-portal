...
package com.liferay.portal.search.test.util.aggregation.metrics.valuecount;
...
public abstract class BaseValueCountAggregationTestCase
	...
	public void testValueCountAggregation() {
		...
		ValueCountAggregation valueCountAggregation = new ValueCountAggregation(
			"valueCount", Field.PRIORITY);

		ValueCountAggregationResult valueCountAggregationResult = search(
			valueCountAggregation);

		Assert.assertEquals(5, valueCountAggregationResult.getValue(), 0);
	}
