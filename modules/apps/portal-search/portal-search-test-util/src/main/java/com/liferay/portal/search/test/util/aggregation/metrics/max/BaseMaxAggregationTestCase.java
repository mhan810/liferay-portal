...
package com.liferay.portal.search.test.util.aggregation.metrics.max;
 ...
 */
public abstract class BaseMaxAggregationTestCase
	...
	public void testMaxAggregation() throws Exception {
		...
		MaxAggregationResult maxAggregationResult = search(maxAggregation);
