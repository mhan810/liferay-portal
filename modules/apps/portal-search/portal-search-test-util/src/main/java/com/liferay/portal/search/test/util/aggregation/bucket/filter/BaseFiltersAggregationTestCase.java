...
package com.liferay.portal.search.test.util.aggregation.bucket.filter;
...
public abstract class BaseFiltersAggregationTestCase
	...
	public void testFilter() throws Exception {
		...
		FiltersAggregation filtersAggregation = new FiltersAggregation(
		...
		FiltersAggregationResult filtersAggregationResult = search(
			filtersAggregation);
		...
		Map<String, AggregationResult> sumUser1ChildrenAggregationResults =
		...
		SumAggregationResult sumAggregationResult =
			(SumAggregationResult)sumUser1ChildrenAggregationResults.get("sum");

		Assert.assertEquals(
			"SumUser1 total priorities", 6, sumAggregationResult.getValue(), 0);
		...
		Map<String, AggregationResult> sumUser2ChildrenAggregationResults =
		...
		SumAggregationResult sumAggregationResult2 =
			(SumAggregationResult)sumUser2ChildrenAggregationResults.get("sum");

		Assert.assertEquals(
			"SumUser1 total priorities", 22, sumAggregationResult2.getValue(),
			0);
	}
