...
public class MicroblogsEntryPersistenceImpl extends BasePersistenceImpl<MicroblogsEntry>
	...
	public List<MicroblogsEntry> findByCompanyId(long companyId, int start,
		...
		List<MicroblogsEntry> list = (List<MicroblogsEntry>)finderCache.getResult(finderPath,
				finderArgs, this);
	...
	public List<MicroblogsEntry> findByCCNI_CCPK(long creatorClassNameId,
		...
		List<MicroblogsEntry> list = (List<MicroblogsEntry>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_CCNI_CCPK,
				finderArgs, this);
	...
	public List<MicroblogsEntry> findByCCNI_CCPK_T(long creatorClassNameId,
		...
		List<MicroblogsEntry> list = (List<MicroblogsEntry>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_CCNI_CCPK_T,
				finderArgs, this);
