...
instead implement `SearchPermissionChecker.getPermissionFilter(...)`.

Any code calling `SearchPermissionChecker.getPermissionQuery(...)` should 
instead call `SearchPermissionChecker.getPermissionFilter(...)`.

Any code implementing `Indexer.getFacetQuery(...)` should instead implement 
`Indexer.getFacetFilter(...)`.
...
`SearchPermissionChecker.getPermissionFilter(...)`, the method was removed as 
opposed to deprecated.