...
if (assetRenderer.isRenderizable()) {
					...
					<div class="task-content-actions">
						<liferay-ui:icon-list>
							<c:if test="<%= assetRenderer.hasViewPermission(permissionChecker) %>">
								<liferay-ui:icon image="view" method="get" url="<%= viewFullContentURL %>" target='<%= assetRenderer.isRenderizable() ? StringPool.BLANK : "_blank" %>' />
							</c:if>
							...
							else if (!assetRenderer.isRenderizable()) {
							...
							<c:choose>
								<c:when test="<%= assetRenderer.hasEditPermission(permissionChecker) && showEditURL %>">
									<liferay-ui:icon image="edit" url="<%= taglibEditURL %>" target='<%= assetRenderer.isRenderizable() ? StringPool.BLANK : "_blank" %>' />
								</c:when>
